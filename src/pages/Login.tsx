  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background flex relative overflow-hidden">
        ...
        {/* Center - Login Form with Premium Glassmorphism */}
        <div className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
          ...
          >
            {/* Glassmorphism Card */}
            <motion.div 
              className="absolute inset-0 -m-6 rounded-[32px] bg-card/40 backdrop-blur-2xl border border-white/10 shadow-2xl shadow-black/5"
            ...
            <motion.div 
              className="absolute -inset-10 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 rounded-full blur-3xl -z-10"
              ...
              >
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <ChronxyxLogo className="w-16 h-16 mx-auto relative" />
                  </div>
                </motion.div>
                <motion.h1 
                  className="text-2xl font-extralight tracking-[0.3em] text-foreground mb-2"
            ...
            <p className="text-center mt-6 text-sm text-muted-foreground">
              ...
              {/* Footer */}
              <motion.p 
                className="text-center mt-8 text-[10px] text-muted-foreground/50 tracking-wider"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
