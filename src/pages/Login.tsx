    ...
    >
      ...
      <div className="w-full max-w-5xl flex items-center justify-center gap-8 relative z-10">
        ...
        >
          ...
          {/* Google Sign In Button with CHRONYX Branding */}
          <div className="relative">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 sm:h-14 mb-2 gap-3 border-2 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
