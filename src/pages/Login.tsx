          ...
          >
            ...
            <div className="space-y-2 mb-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 sm:h-14 gap-3 border-2 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 relative overflow-hidden group"
              ...
              >
                {isGoogleLoading ? (
                  <>
                    ...
                    <span className="font-medium animate-pulse">Connecting to CHRONYX...</span>
                  </>
                ) : (
                  <>
