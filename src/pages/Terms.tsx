      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The CHRONYX platform, including its design, features, and code, is owned  You retain ownership of all content you upload to the platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              For questions about these terms, contact us at legal@getchronyx.com
            </p>
          </section>
        </div>
