...
export const generateTaxPDF = async (data: TaxPDFData): Promise<Blob> => {
  ...
  yPos += 6;
  addText("CHRONYX", margin, yPos, { fontSize: 8, color: mediumGray });
  ...
  const disclaimer = [
    ...
    "5. CHRONYX and CHRONYX shall not be liable for any discrepancies.",
  ...
  addText("CHRONYX - A CHRONYX product", pageWidth / 2, footerY + 5, { fontSize: 7, color: [255, 255, 255], align: "center" });
  addText("www.getchronyx.com | www.getchronyx.com", pageWidth / 2, footerY + 9, { fontSize: 6, color: [200, 200, 200], align: "center" });
