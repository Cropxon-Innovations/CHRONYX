...
export const CertifiedExportDialog = ({
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      pdf.text(
        "Verified and generated by Chronyx, a division of CHRONYX",
        pageWidth / 2,
        yPos,
        { align: "center" }
      );
      yPos += 5;
      pdf.text(
        "This certificate is digitally signed and can be verified at chronyx.app",
        pageWidth / 2,
        yPos,
        { align: "center" }
      );
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="p-3 rounded-lg bg-muted/50 border border-border flex items-start gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              It carries the seal of CHRONYX.
            </p>
          </div>
        </div>
