    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          // Apple-level typography with proper heading hierarchy - Enhanced sizes
          'prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-foreground prose-headings:leading-tight',
          'prose-h1:text-5xl prose-h1:font-black prose-h1:mb-6 prose-h1:mt-8 prose-h1:tracking-tighter',
          'prose-h2:text-4xl prose-h2:font-extrabold prose-h2:mb-5 prose-h2:mt-7',
          'prose-h3:text-3xl prose-h3:font-bold prose-h3:mb-4 prose-h3:mt-6',
          'prose-h4:text-2xl prose-h4:font-semibold prose-h4:mb-3 prose-h4:mt-5',
          'prose-h5:text-xl prose-h5:font-medium prose-h5:mb-3 prose-h5:mt-4',
          'prose-h6:text-lg prose-h6:font-medium prose-h6:mb-2 prose-h6:mt-4 prose-h6:text-muted-foreground',
          ...
          'prose-li:my-1.5 prose-li:text-foreground prose-li:marker:text-primary',
          // Blockquote with premium styling
          'prose-blockquote:border-l-4 prose-blockquote:border-primary',
          'prose-blockquote:pl-6 prose-blockquote:pr-4 prose-blockquote:py-2',
          'prose-blockquote:italic prose-blockquote:text-muted-foreground prose-blockquote:my-6',
          'prose-blockquote:bg-muted/30 prose-blockquote:rounded-r-xl prose-blockquote:not-italic',
          'prose-code:bg-muted prose-code:px-2 prose-code:py-1 prose-code:rounded-lg prose-code:text-sm prose-code:font-mono prose-code:text-primary',
          'prose-pre:bg-muted prose-pre:border prose-pre:border-border prose-pre:rounded-xl prose-pre:my-4',
          // Table with visible borders and styling
          '[&_table]:w-full [&_table]:my-6 [&_table]:border-collapse [&_table]:border [&_table]:border-border [&_table]:rounded-xl [&_table]:overflow-hidden',
          '[&_td]:border [&_td]:border-border [&_td]:p-3 [&_td]:text-sm [&_td]:text-foreground',
          '[&_th]:border [&_th]:border-border [&_th]:p-3 [&_th]:bg-muted [&_th]:font-semibold [&_th]:text-left [&_th]:text-foreground',
          '[&_tr]:border-b [&_tr]:border-border',
          '[&_tr:last-child]:border-b-0',
          'prose-hr:border-border prose-hr:my-8',
          // Task list styles
          '[&_.task-list]:list-none [&_.task-list]:pl-0 [&_.task-list]:my-4',
          '[&_.task-item]:flex [&_.task-item]:items-start [&_.task-item]:gap-3 [&_.task-item]:my-2',
          '[&_.task-item_input]:mt-1.5 [&_.task-item_input]:accent-primary [&_.task-item_input]:w-4 [&_.task-item_input]:h-4',
        ),
